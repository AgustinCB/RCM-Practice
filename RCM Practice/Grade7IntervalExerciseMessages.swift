...
struct Grade7IntervalExerciseMessages: ExerciseMessages {
    ...
    let GUESSES: [String] = ["Minor Second", "Major Second", "Minor Third", "Major Third", "Perfect Forth", "Perfect Fifth", "Minor Sixth", "Major Sixth", "Minor Seventh", "Major Sevent", "Octave"]
